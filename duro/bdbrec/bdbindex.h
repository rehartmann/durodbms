...
RDB_index *
RDB_create_bdb_index(RDB_recmap *, const char *, const char *,
        RDB_environment *, int, const RDB_field_descriptor[],
        const RDB_compare_field[], int, RDB_rec_transaction *,
        RDB_exec_context *);

RDB_index *
RDB_open_bdb_index(RDB_recmap *, const char *namp, const char *filenamp,
...
RDB_bool
RDB_bdb_index_is_ordered(RDB_index *);

/* Delete an index. */
int
RDB_delete_bdb_index(RDB_index *, RDB_environment *, RDB_rec_transaction *,
        RDB_exec_context *);

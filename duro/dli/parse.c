...
int RDB_parse_tokens[] = {
    ...
    TOK_CONSTRAINT, TOK_DEFAULT, TOK_DELETE, TOK_DESC, TOK_DIVIDEBY, TOK_DROP,
    TOK_D_INSERT, TOK_D_UNION, TOK_ELSE, TOK_END, TOK_EXPLAIN, TOK_EXTEND,
    TOK_EXTERN, TOK_FOR, TOK_FROM, TOK_GROUP,

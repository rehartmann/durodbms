 ...
 * object. Unlike java.lang.Boolean, the value can be updated.
 * 
...
public class UpdatableBoolean implements Serializable,
     ...
     * only if the argument is not null and is an UpdatableBoolean object that
    ...
    /**
     * Returns a String object representing this UpdatableBoolean's value. If
     * this object represents the value true, a string equal to "true" is

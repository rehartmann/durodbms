...
public class TestUserDefOp {
    ...
    private static String test2(String arg1, Integer arg2, Double arg3,
	    Boolean arg4, byte[] arg5, Tuple arg6, Set<Tuple> arg7, String[] arg8) {
	return arg1 + arg2 + arg3 + arg4 + (int) arg5[0] + (int) arg5[1]
		+ arg6.getAttribute("s")
		+ arg7.iterator().next().getAttribute("n")
		+ arg8[0];
    }
    ...
    @SuppressWarnings("unused")
    private static void test1u(StringBuilder au, String a,
	    UpdatableInteger bu, Integer b, UpdatableBoolean cu, Boolean c,
	    UpdatableDouble du, Double d, ByteArray eu, byte[] e,
	    Tuple fu, Tuple f, Set<Tuple> gu, Set<Tuple> g,
	    ArrayList<Tuple> hu, Tuple[] h) {
	au.append(a);
	...
	fu.setAttribute("s", (String) fu.getAttribute("s") + (String) f.getAttribute("s"));
    ...
    public void testUpdateOp1() throws DException {
        ...
        assertArrayEquals(new byte[] { (byte) 1, (byte) 0x0ff, (byte) 2, (byte) 0x0ef },
        	(byte[]) session.evaluate("eu"));
        Tuple t = new Tuple();
    ...
    public void testUpdateOpException() throws DException {
        ...
        session.execute("operator testuex (a string) updates { a }"
        	...
        	+ " end operator;");
        try {
            session.execute("var a init 'yxy';"
        	    + "testuex(a);");
